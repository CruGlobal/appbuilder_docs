...
After selecting the data source detail fields are added to the layout. These can be reordered or removed. Text and label widgets can be added to customize the look of the card.
